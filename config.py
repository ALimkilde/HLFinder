...
MAX_TREE_FRACTION = 0.5      # Maximium fraction of tree height to put anchor 
                             # (0.6 is allowing 6m high anchors in a 10m tree)
TREE_DIST         = 10        # How many meters where we allow other trees being "in the way"
...
# Clustering settings
CLUSTER_RADIUS    = 50       # Only save the best line in this radius in meters
